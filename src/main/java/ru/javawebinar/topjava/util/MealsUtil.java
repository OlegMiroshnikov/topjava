...
public class MealsUtil {
    ...
    public static final List<User> USERS = Arrays.asList(
            new User("Oleg", "oleg.psoft@gmail.com", "oleg_passw", Role.ROLE_USER),
            new User("Igor", "igor.psoft@gmail.com", "igor_passw", Role.ROLE_USER),
            new User("Admin", "admin.psoft@gmail.com", "admin_passw", Role.ROLE_ADMIN));
    ...
    public static List<MealTo> getFilteredTos(Collection<Meal> meals, int caloriesPerDay, LocalTime startTime, LocalTime endTime) {
        return filteredByStreams(meals, caloriesPerDay, meal -> DateTimeUtil.isBetweenTimeInclusive(meal.getTime(), startTime, endTime));
    }
